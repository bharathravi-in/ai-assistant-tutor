                    ...
                    <div className="h-full flex flex-col bg-slate-50 dark:bg-gray-950 shadow-2xl border-l border-white/10 overflow-hidden">
                        ...
                        <div className="px-6 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex">
                            <button
                                ...
                                className={`flex items-center gap-2 px-6 py-3 text-sm font-bold border-b-2 transition-all ${activeTab === 'diy' ? 'border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'border-transparent text-gray-500 hover:text-gray-700'}`}
                            >
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-6 py-3 text-sm font-bold border-b-2 transition-all ${activeTab === 'visual' ? 'border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'border-transparent text-gray-500 hover:text-gray-700'}`}
                            >
                            ...
                            {isLoading ? (
                                <div className="h-full flex flex-col items-center justify-center space-y-4 text-center">
                                    <div className="relative">
                                        ...
                                        <Palette className="absolute inset-0 m-auto w-6 h-6 text-indigo-500 animate-pulse" />
                                    </div>
                                    <div>
                                ...
                                <div className="space-y-6 animate-slide-up print:bg-white print:text-black">
                                    {activeTab === 'diy' ? (
                                        <div className="space-y-6">
                                            ...
                                            <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 border border-indigo-500/10 shadow-sm">
                                                ...
                                                <div className="space-y-6">
                                                    <div>
                                                        <h4 className="text-xs font-bold uppercase tracking-widest text-indigo-500 mb-3 ml-1">Materials Needed</h4>
                                                    ...
                                                    <div>
                                                        <h4 className="text-xs font-bold uppercase tracking-widest text-indigo-500 mb-3 ml-1">Step-by-Step Guide</h4>
                                                        <div className="space-y-3">
                                                            {tlm.diy_workshop.steps.map((step, i) => (
                                                                <div key={i} className="flex gap-4 p-3 bg-gray-50/50 dark:bg-gray-800/20 rounded-2xl border border-gray-100/50 dark:border-gray-800/50">
                                                                    <div className="w-6 h-6 rounded-lg bg-indigo-500 text-white flex items-center justify-center text-xs font-bold shrink-0">
                                                                        {i + 1}
                                                                    </div>
                                                    ...
                                                    <div className="p-4 bg-indigo-500/5 dark:bg-indigo-500/10 rounded-2xl border border-indigo-500/20">
                                                        <h4 className="text-xs font-bold text-indigo-600 dark:text-indigo-400 uppercase mb-2">💡 Classroom Usage Tip</h4>
                                                    ...
                                                    {tlm.visual_kit.flashcards.map((card, i) => (
                                                        <div key={i} className="group perspective h-48">
                                                            <div className="relative w-full h-full text-center transition-transform duration-500 transform-style-3d group-hover:rotate-y-180">
                                                                {/* Front */}
                                                                <div className="absolute w-full h-full backface-hidden bg-white dark:bg-gray-900 rounded-2xl border-2 border-dashed border-indigo-500/20 flex flex-col items-center justify-center p-4">
                                                                    <div className="text-[10px] uppercase font-bold text-indigo-500/50 mb-2">FRONT</div>
                                                                    <p className="text-lg font-bold text-gray-900 dark:text-white">{card.front}</p>
                                                                </div>
                                                                {/* Back */}
                                                                <div className="absolute w-full h-full backface-hidden rotate-y-180 bg-indigo-500 text-white rounded-2xl flex flex-col items-center justify-center p-4">
                        ...
                        <div className="p-6 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 space-y-3">
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className="w-full flex items-center justify-center gap-2 px-4 py-4 bg-indigo-600 text-white rounded-2xl font-bold hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-500/25 disabled:opacity-50"
                            >
